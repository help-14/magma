...
export const getWeather = query(
	...
	async ({ provider: rawProvider, apiKey, cityName, latitude, longitude, cacheTtl }) => {
...
async function fetchOpenMeteo(lat: number, lon: number, displayName = '') {
	...
	return {
		...
		main: {
			...
			feels_like: celsiusToKelvin(cur.apparent_temperature ?? cur.temperature_2m ?? 20),
			temp_min: day.temperature_2m_min?.[0] != null ? celsiusToKelvin(day.temperature_2m_min[0]) : celsiusToKelvin(cur.temperature_2m ?? 20),
			temp_max: day.temperature_2m_max?.[0] != null ? celsiusToKelvin(day.temperature_2m_max[0]) : celsiusToKelvin(cur.temperature_2m ?? 20),
...
async function fetchWeatherApi(lat: number, lon: number, key: string) {
	...
	return {
		...
		visibility: cur.vis_km != null ? Math.round(cur.vis_km * 1000) : null as number | null,
		wind: {
			speed: cur.wind_kph != null ? Math.round(cur.wind_kph / 3.6 * 10) / 10 : 0,
...
const WEATHERAPI_TO_OWM: Record<number, number> = {
	1000: 800, 1003: 801, 1006: 802, 1009: 803, 1030: 701,
	1063: 500, 1066: 600, 1069: 611, 1072: 611,
	1087: 200, 1114: 600, 1117: 602,
	1135: 741, 1147: 741,
	1150: 300, 1153: 301, 1168: 302, 1171: 302,
	1180: 500, 1183: 501, 1186: 502, 1189: 502, 1192: 502, 1195: 502,
	1198: 511, 1201: 511,
	1204: 611, 1207: 612,
	1210: 600, 1213: 601, 1216: 602, 1219: 601, 1222: 602, 1225: 602,
	1237: 612,
	1240: 500, 1243: 501, 1246: 502,
	1249: 611, 1252: 612,
	1255: 600, 1258: 601,
	1261: 612, 1264: 612,
	1273: 200, 1276: 201,
