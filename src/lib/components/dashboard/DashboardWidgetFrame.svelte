...
>
  ...
  {#if refreshHandler && !editMode}
    <Button
      ...
      title={m.widget_refresh()}
      aria-label={m.widget_refresh_aria_label()}
    >
  ...
  {#if editMode}
    <Button
      ...
      aria-label={m.widget_resize_left()}
      title={m.widget_resize_left()}
    ...
    <Button
      ...
      aria-label={m.widget_resize_right()}
      title={m.widget_resize_right()}
      onpointerdown={(event: PointerEvent) =>
    ...
    <Button
      ...
      aria-label={m.widget_resize_bottom()}
      title={m.widget_resize_bottom()}
      onpointerdown={(event: PointerEvent) =>
